...
import { NavigationContext, CartContext } from '../App';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function CheckoutPage() {
  ...
  const { cartItems, updateQuantity: updateCartQuantity, removeFromCart } = useContext(CartContext);
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {cartItems.length === 0 ? (
              <div className="text-center py-16">
                <p className="text-muted-foreground text-lg mb-4">Keranjang Anda kosong</p>
                <button
      ...
      <AlertDialog open={itemToDelete !== null} onOpenChange={(open) => {
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Apakah Anda yakin ingin menghapus item ini dari keranjang belanja? Tindakan ini tidak dapat dibatalkan.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
